...
namespace build
{
    internal class Build
    {
        ...
        private const string GITHUB_REPO = "https://github.com/jasperfx/JasperFx.CodeGeneration.git";
        ...
        private static void Main(string[] args)
        {
            ...
            Target("restore", () =>
            {
                Run("dotnet", "restore JasperFx.CodeGeneration.sln");
            });
            ...
            var nugetProjects = new string[]{
                "./src/JasperFx.CodeGeneration", 
                "./src/JasperFx.CodeGeneration.Commands", 
